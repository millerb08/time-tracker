...
if(isset($_GET["id"])){
  ...
  list($project_id, $tittle, $category) = get_project($project_id);
}

if ($_SERVER["REQUEST_METHOD"] == "POST"){
  $project_id = filter_input(INPUT_POST, "id", FILTER_SANITIZE_STRING);
  ...
  if(empty($title) || empty($category)){
    ...
    if(add_project($title,$category,$project_id)){
      ...
      $error_message = "Project not added correctly";
    }
  }
}
